# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-10-23 23:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('fiction', 'fiction'), ('fear', 'fear'), ('fear1', 'fear1'), ('fear2', 'fear2'), ('fear3', 'fear3')], default='fiction', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('my_field', multiselectfield.db.fields.MultiSelectField(choices=[('fiction', 'fiction'), ('fear', 'fear'), ('fear1', 'fear1'), ('fear2', 'fear2'), ('fear3', 'fear3')], default='fiction', max_length=30)),
                ('user', models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
