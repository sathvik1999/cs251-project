# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-10-16 21:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploader', models.CharField(default=b'', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rate1', models.FloatField(blank=True, default=0.0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('flist', models.ManyToManyField(related_name='owner', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('com', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='blog.Community')),
                ('jplist', models.ManyToManyField(related_name='jplist', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('picture', models.ImageField(default=b'pic_folder/None/no-img.jpg', upload_to=b'images/')),
